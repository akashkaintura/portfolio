import Picture from "../../img/akash2.jpeg";
      ...
      <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 text-white">
        <div className="max-w-xl mb-10 md:mx-auto lg:max-w-5xl md:mb-12">
          ...
          <div className="w-full flex flex-wrap">
            ...
            <img src={Picture} alt="Akash" className="mx-auto rounded-lg border border-gray-800 shadow-md" />
            </div>
            <div className="w-full lg:w-1/2 flex flex-col justify-center p-2 py-8">
              <p className="text-base text-gray-400 md:text-lg">
                My name is Akash and I am full stack developer. 
                I have been working in the IT industry for 4 years
                and have developed a keen eye for details. In my free
                time, I enjoy listening to music and trading Equity Markets, I have always had
                a love for music and find that it helps to relax and inspire me
                in my work.
              </p>
              <p className="mt-4 text-base text-gray-400 md:text-lg">
                I initially started coding during college and then no look back, but quickly realized that
